export const WEDDING_CONFIG = {
  ...
  date: process.env.WEDDING_DATE || process.env.NEXT_PUBLIC_WEDDING_DATE || "2025-11-08T16:00:00",

  // Event details
  title: "Casamiento Nuria & Juanca",
  venue: {
    name: "Estancia La Lupita",
    address: "Gral. Viamonte 2298, B1669 Del Viso, Provincia de Buenos Aires, Argentina",
