    ...
    return (
      <section id="rsvp" className="py-16 relative">
        <div className="max-w-md mx-auto bg-white/90 backdrop-blur-sm border-2 border-ocean-blue rounded-3xl p-8 text-center">
          <h2 className="text-3xl font-handwritten text-ocean-blue mb-4">¡Gracias!</h2>
  ...
  return (
    <section id="rsvp" className="py-16 relative">
      <div className="text-center mb-8">
        <p className="text-sm text-ocean-blue font-light tracking-[0.2em] uppercase mb-2">RSVP</p>
        <h2 className="text-3xl md:text-4xl font-handwritten text-ocean-blue mb-4">Confirmación</h2>
        <p className="text-soft-gray font-light">Por favor, confirmá tu asistencia</p>
      </div>
      ...
      <div className="max-w-md mx-auto bg-white/90 backdrop-blur-sm border-2 border-ocean-blue rounded-3xl p-8">
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex items-center space-x-2">
            ...
            />
            <Label htmlFor="is_minor" className="text-sm font-light text-soft-gray">
              Soy menor de edad
            </Label>
          </div>
          ...
          <div className="space-y-3">
            <Label className="text-soft-gray font-light">¿Necesitás traslado?</Label>
            <RadioGroup name="transfer" defaultValue="no">
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="transfer-yes" className="text-soft-gray font-light">
                  Sí
                </Label>
              </div>
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="no" id="transfer-no" className="border-2 border-ocean-blue/30 text-ocean-blue" />
                <Label htmlFor="transfer-no" className="text-soft-gray font-light">
                  No
                </Label>
              </div>
            </RadioGroup>
          ...
          <Button
            type="submit"
            disabled={isPending}
            className="w-full bg-ocean-blue hover:bg-sky-blue text-white font-light tracking-wide rounded-full"
          >
