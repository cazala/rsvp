      ...
      <div className="relative">
        ...
        <div className="w-80 h-80 md:w-96 md:h-96 border-4 border-ocean-blue rounded-full flex items-center justify-center mb-8">
          ...
          <div className="text-center">
            <p className="text-sm text-ocean-blue font-light tracking-[0.3em] uppercase mb-2">08.11.2025</p>
            ...
            <p className="text-sm text-ocean-blue font-light tracking-[0.2em] uppercase">se casan
</p>
          </div>
        </div>
      </div>
